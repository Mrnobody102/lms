...
- **Queues**: Bull (Redis) - *Dự kiến dùng cho xử lý video*.
...
- **Framework**: **React Native (Expo)**.
    - *Lý do*: Tận dụng được tối đa code logic đã viết bằng TypeScript trong Monorepo (các gói `packages/shared`, `packages/api-client`). Đội ngũ dev frontend (React/Next.js) có thể dễ dàng tham gia phát triển.
- **Kiến trúc**:
