...
| Exam/Test          | Admin UI MVP   | Exam template, section/question, attempt lifecycle, scoring/review API và admin UI đã có |
...
Đã có backend MVP và admin template UI:
...
2. Practice/reporting nâng cao theo unit/skill.
