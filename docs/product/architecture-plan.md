...
- Exam backend MVP với template, section/question, attempt, answer snapshot, scoring, review và admin template UI.
...
2. Practice/Exam reporting aggregate.
3. Activation/license.
4. Program/level hierarchy nếu cần.
5. AI conversation.
