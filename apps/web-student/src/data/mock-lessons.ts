...
export const MOCK_COURSE: Course = {
  ...
  lessons: [
    ...
    },
    {
      ...
      completed: false,
      content:
        "Trong bài học này, chúng ta sẽ tìm hiểu về cách diễn đạt sở thích trong tiếng Trung. Sử dụng cấu trúc: 我喜欢 (Wǒ xǐhuān) + [Sở thích]. Ví dụ: 我 thích xem phim (Wǒ xǐhuān kàn diànyǐng) - Tôi thích xem phim.",
      courseId: "hsk1-basic",
      order: 6,
    },
    {
